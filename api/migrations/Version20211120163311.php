 ...
 */
final class Version20211120163311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE domain (id INT NOT NULL, extension_id INT NOT NULL, customer_id INT NOT NULL, domaine_name VARCHAR(255) NOT NULL, registered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expired_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE extension (id INT NOT NULL, extension_type_id INT NOT NULL, extension VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9FB73D778ABCA2F9 ON extension (extension_type_id)');
        $this->addSql('CREATE TABLE extension_type (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
